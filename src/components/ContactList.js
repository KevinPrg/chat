...
const list = [
    ...
    {
        avatar: 'https://vignette.wikia.nocookie.net/schtroumpfs/images/7/73/Le-Grand-Schtroumpf_original_backup.jpg/revision/latest?cb=20150309140805&path-prefix=fr' ,
        name: 'Grand Schtroumpf',
        online: true
    },
    {
        avatar: 'https://photos.lci.fr/images/613/344/rambo-820x490-e55f6f-0@1x.jpeg',
        name: 'John Rambo',
        online: false
    }
  ];
